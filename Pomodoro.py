...
#Setting up Window's size and design
class PomodoroTimer:
    def __init__(self, root):
        ...
        self.frame.place(relx=0.5, rely=1, anchor=S, relwidth=1)
        ...
        #Start Button Design
        self.start_btn = Button(self.frame,text = "Start", font= ("Times", 20), fg = "black", activebackground = "grey", command=self.start_time)
        self.start_btn.pack(side = LEFT)

        #Stop Button Design
        self.stop_btn = Button(self.frame, text = "Stop", font= ("Times", 20), fg = "black", activebackground = "grey", command=self.pause_time)
        self.stop_btn.pack(side = LEFT)


        #Reset Button Design
        self.reset_btn = Button(self.frame, text = "Reset", font= ("Times", 20), fg = "black", activebackground = "grey", command=self.reset_time)
        self.reset_btn.pack(side = LEFT)

        #Timer Variables
        self.run_timer = FALSE #Haven't run yet
        self.start_timer = 0
